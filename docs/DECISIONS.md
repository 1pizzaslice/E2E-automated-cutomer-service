...
- Follow-up: Retrieval half (search endpoint, citation metadata, stale/active exclusion, tenant-isolation and prompt-injection tests). Choose and document a production embedding model; re-embed if its dimension differs from 1536.
